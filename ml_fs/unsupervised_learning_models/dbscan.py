...
import numpy as np
from ml_sf.common_utils import Plot, euclidean_distance, normalize


"""This Pyhton file contains explanation Destiny
Based Scan (DBS) unspervised trainig model by excersise"""
