...
from ml_sf.deep_learning.optimizers import Adam
from ml_sf.deep_learning.loss_functions import CrossEntropy
from ml_sf.deep_learning.layers import Dense, Dropout, Flatten, Activation, Reshape, BatchNormalization, ZeroPadding2D, Conv2D, UpSampling2D
from ml_sf.deep_learning import NeuralNetwork


"""This Pyhton file contains explanation Deep Convolutional Generative
Adversarial Network (DCGAN) unspervised trainig model by excersise"""


"""Generative Adversarial Networks (GANs) are one of the most interesting
ideas in computer science today. Two models are trained simultaneously by
an adversarial process. A generator ("the artist") learns to create images
that look real, while a discriminator ("the art critic") learns to tell real
images apart from fakes. https://www.tensorflow.org/tutorials/generative/dcgan"""
class DCGAN():
    def __init__(self):
        self.img_rows = 28
        self.img_cols = 28
