...
from ml_sf.common_utils import normalize, euclidean_distance, calculate_covariance_matrix
from ml_sf.common_utils import Plot


"""This Pyhton file contains explanation Gaussian Mixture
