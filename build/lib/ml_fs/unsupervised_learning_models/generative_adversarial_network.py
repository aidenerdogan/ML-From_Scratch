...
from ml_sf.deep_learning_models.optimizers import Adam
from ml_sf.deep_learning_models.loss_functions import CrossEntropy
from ml_sf.deep_learning_models.layers import Dense, Dropout, Flatten, Activation, Reshape, BatchNormalization
from ml_sf.deep_learning_models import NeuralNetwork


"""This Pyhton file contains explanation Generative Adversarial (GAN)
unspervised trainig model by excersise"""
