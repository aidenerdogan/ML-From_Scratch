...
import numpy as np
from ml_sf.common_utils import calculate_covariance_matrix

"""This Pyhton file contains explanation Principal Component Anyalsis
(PCA) unspervised trainig model by excersise"""
