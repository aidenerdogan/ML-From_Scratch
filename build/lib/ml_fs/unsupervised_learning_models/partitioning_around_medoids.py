...
import numpy as np
from ml_sf.common_utils import normalize, euclidean_distance, Plot
from ml_sf.unsupervised_learning_models import PCA


"""This Pyhton file contains explanation Pastitioning Around Medoids
(PAM) unspervised trainig model by excersise"""
